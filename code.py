...
if 0<nub<=0.04:
 delta_a1 = nub/0.04
 A1_0 = 2e-9*kb**6-3e-7*kb**5+2e-5*kb**4-0.0005*kb**3+0.0081*kb**2-0.0078*kb+6.6753
 ...
 A1_004 = -4e-8*kb**6+3e-5*kb**5-0.0001*kb**4+0.0018*kb**3-0.0105*kb**2+0.0754*kb+5.6731
 A1_01 = 1e-7*kb**6 - 8e-6*kb**5 + 0.0002*kb**4 - 0.0036*kb**3 + 0.0269*kb**2 - 0.0349*kb + 5.8654
 ...
 A1_02 = -3e-07*kb**6 + 1e-05*kb**5 - 0.0003*kb**4 + 0.0018*kb**3 - 0.001*kb**2 + 0.0579*kb + 5.0245
 A1_03 = 1e-6*kb**6 - 6e-5*kb**5 + 0.0014*kb**4 - 0.0167*kb**3 + 0.0953*kb**2 - 0.1395*kb+5.2554
