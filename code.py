...
#ksi = -2e-8*(lyambda/10)**6 + 2e-6*(lyambda/10)**5 - 0.0001*(lyambda/10)**4 + 0.0025*(lyambda/10)**3 - 0.031*(lyambda/10)**2 + 0.2082*(lyambda/10) + 0.075
...
if 0<nub<=0.04:
 delta_a1 = nub/0.04
 A1_0 = 2e-9*kb**6-3e-7*kb**5+2e-5*kb**4-0.0005*kb**3+0.0081*kb**2-0.0078*kb+6.2208
 A1_004 = -4e-8*kb**6+3e-5*kb**5-0.0001*kb**4+0.0018*kb**3-0.0105*kb**2+0.0754*kb+5.6635
 phi_1 = A1_004 + delta_a1*(A1_0-A1_004)
elif 0.04<nub<0.1:
 delta_a2 = (nub-0.04)/0.06
 A1_004 = -4e-8*kb**6+3e-5*kb**5-0.0001*kb**4+0.0018*kb**3-0.0105*kb**2+0.0754*kb+5.6635
 A1_01 = 1e-7*kb**6 - 8e-6*kb**5 + 0.0002*kb**4 - 0.0036*kb**3 + 0.0269*kb**2 - 0.0349*kb + 5.3678
 ...
 A1_01 = 1e-7*kb**6 - 8e-6*kb**5 + 0.0002*kb**4 - 0.0036*kb**3 + 0.0269*kb**2 - 0.0349*kb + 5.5.3678
 phi_1 = A1_02 + delta_a3*(A1_01-A1_02)
elif 0.2<nub<0.3:
 delta_a4 = (nub-0.2)/0.1
 A1_02 = -3e-07*kb**6 + 1e-05*kb**5 - 0.0003*kb**4 + 0.0018*kb**3 - 0.001*kb**2 + 0.0579*kb + 4.9632
 A1_03 = 1e-6*kb**6 - 6e-5*kb**5 + 0.0014*kb**4 - 0.0167*kb**3 + 0.0953*kb**2 - 0.1395*kb+4.8701
 phi_1 = A1_03 + delta_a4*(A1_02-A1_03)
 
#phi2
if 0<nub<=0.3:
 delta_b1 = nub/0.3
 B0_0= 1e-7*kb**6 - 8e-6*kb**5 + 0.0002*kb**4 - 0.0036*kb**3 + 0.0242*kb**2 - 0.0086*kb + 4.36
 B0_03= -2e-7*kb**6 + 1e-5*kb**5 - 0.0004*kb**4 + 0.0049*kb**3 - 0.0293*kb**2 + 0.115*kb + 4.1019
